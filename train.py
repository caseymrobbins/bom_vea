...
for epoch in range(1, EPOCHS + 1):
    ...
    for batch_idx, (x, _) in enumerate(pbar):
        ...
        if needs_recal and batch_idx < CALIBRATION_BATCHES:
            with torch.no_grad():
                raw = compute_raw_losses(recon, x, mu, logvar, z, model, vgg, split_idx, discriminator, x_aug, tc_logits)
            ...
            if not goal_system.calibrated:
                ...
                cal_result = grouped_bom_loss(recon, x, mu, logvar, z, model, goal_system, vgg, split_idx, GROUP_NAMES, discriminator, x_aug, tc_logits)
        ...
        result = grouped_bom_loss(recon, x, mu, logvar, z, model, goal_system, vgg, split_idx, GROUP_NAMES, discriminator, x_aug, tc_logits)
